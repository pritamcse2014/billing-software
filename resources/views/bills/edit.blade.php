...
<div class="container">
    ...
    @method('PUT') <!-- This line is crucial for Laravel to recognize it as an update request -->
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" class="form-control" id="website_name" name="website_name" value="{{ $website->name }}">
        </div>

        <div class="form-group mt-3">
            <label for="url">Website URL</label>
            <input type="text" class="form-control" id="website_url" name="website_url" value="{{ $website->url }}">
        </div>

        <div class="form-group mt-3">
            <label for="bill">Website Bill</label>
            <input type="number" class="form-control" id="website_bill" name="website_bill" value="{{ $website->bill }}">
        </div>
        <div class="form-group mt-3">
            <label for="end_date">Website End Date</label>
            <input type="text" class="form-control" id="website_end_date" name="website_end_date" value="{{ $website->end_date }}">
        </div>
